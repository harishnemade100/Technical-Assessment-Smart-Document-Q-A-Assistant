...
function AskQuestionBox({ selectedDocId }) {
    ...
    const handleAskQuestion = async ()=>{
        if (!selectedDocId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please select a document first!");
            return;
        }
        if (!question.trim()) {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Answer received!");
        } catch (err) {
            console.error("Error fetching answer:", err);
            setError("Failed to fetch the answer. Please try again.");
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Error fetching answer");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f839d64f._.js.map